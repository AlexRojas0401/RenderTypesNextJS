...
"use client" // siempre que se utilice un hoo de react 

import { SliderBar } from "@/components/passwords/slider"
...
const PasswordsPage = () => {
    ...
    }, [longitudPass, mayusculas, , minusculas, simbolos, numeros])
    ...
    return (
        <div className="bg-slate-100 w-full h-screen flex justify-center items-center">
            <div className="border border-gray-500 p-5 rounded">
                ...
                <div className="flex">
                    <input type="text" value={inputValue}
                        onChange={e => setInputValue(e.target.value)} placeholder="New Password" className="rounded p-2 my-2 border" />
            ...
            <div className="absolute bottom-5 right-5">
                {
                    showMessage && (<p className=" flex gap-5 justify-between bg-green-500 text-white p-2 w-full text-center mt-5 text-sm">
                        <span>
                            Contraseña Copiada
                        </span>
